...
conversation = [
    {
        "role": "system",
        "content": "You are Jarvis, a helpful AI assistant for a software engineer. Your creator is Arnab Dey. Provide concise, accurate answers to technical questions.",
    }
]
...
def brain(user_input):
    ...
    response = client.chat.completions.create(
        model="openai/gpt-oss-20b", messages=conversation, max_tokens=2500
    )
